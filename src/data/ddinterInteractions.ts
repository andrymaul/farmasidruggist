...
,
  ...
  },
  {
      ...
      "clinicalOutcome": "Hiperkalemia berat (K+ > 6.0 mEq/L) yang memicu aritmia ventrikel, asistol, dan gagal ginjal akut.",
      "management": "Kombinasi ini sering digunakan pada gagal jantung (RALES Trial) tetapi WAJIB batasi spironolakton pada dosis rendah (12.5 - 25 mg/hari) dan pantau ketat kalium & eGFR pada hari ke-3, 7, 14, lalu bulanan.",
...
,
  ...
  },
  {
      ...
      "clinicalOutcome": "Bioavailabilitas ciprofloxacin anjlok drastis hingga > 85-90%, MEMICU KEGAGALAN TERAPI INFEKSI BAKTERI BERAT / SEPSIS.",
      "management": "HINDARI pemberian bersamaan. BERIKAN CIPROFLOXACIN MINIMAL 2 JAM SEBELUM ATAU 6 JAM SETELAH SUKRALFAT oral.",
      "evidenceLevel": "Level 1 - Well Established (FDA Prescribing Info / Sanford Guide)",
  ...
  },
  {
      ...
      "clinicalOutcome": "Penurunan bioavailabilitas levotiroksin yang memicu KEGAGALAN KONTROL TIROID DAN HIPOTIROIDISME KLINIS BERAT (lonjakan kadar TSH serum).",
      "management": "BERIKAN JEDA WAKTU MINIMAL 4 JAM antara konsumsi Levothyroxine (pagi hari perut kosong) dengan Sukralfat.",
      "evidenceLevel": "Level 1 - Well Established (American Thyroid Association / FDA Label)",
