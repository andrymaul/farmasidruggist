...
export const PRICING_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    description: 'Akses lengkap ke seluruh 18+ modul klinis terpadu: IV ICU, BUD racikan, dosis anak, bumil & busui, polifarmasi, hingga Pusat Belajar Farmasi.',
    features: [
      'Semua Fitur Paket Pemula (Monografi & Uji Interaksi Penuh)',
      'Kompatibilitas Injeksi IV & ICU (ASHP Trissel’s 2024 / Y-Site & Pelarut Infus)',
      'Kalkulator Beyond-Use Date (BUD) Racikan USP <795> & Farmakope Indonesia VI',
      'Kalkulator Dosis Pediatrik & Puyer Anak (Berat Badan & BSA Mosteller)',
      'Skrining Keamanan Ibu Hamil (FDA PLLR Trimester 1–3) & Laktasi Hale (L1–L5)',
      'Evaluasi Polifarmasi Geriatri (Kriteria Beers 2023, STOPP/START & Antikolinergik)',
      'Generator Kartu Informasi Obat (PIO) Edukasi WhatsApp Pasien (1-Klik)',
      'Pusat Belajar Farmasi (Simulasi Bank Soal CBT Vignette & OSCE Station Blueprint)',
      'Skrining Interaksi Obat & Hasil Uji Lab Semu (False Positive/Negative)',
      'Penapisan Interaksi Herbal & Jamu Indonesia vs Obat Resep (FOHI & Fitofarmaka)',
      'Pusat Analisis Efek Samping Obat (MESO) & Algoritma ADR Naranjo Probabilitas',
      'Suite Kalkulator Medis Terpadu (14+ Skor Klinis, Dosis Ginjal CrCl/eGFR & Jiwa SRQ-20)',
      'Database Lengkap Panduan Terapi Klinis (PNPK Kemenkes RI, PERKI, PERKENI & PAPDI)',
      'Deteksi Interaksi Obat-Makanan (DFI) & Duplikasi Terapi Pengobatan',
      'Kustomisasi Kop Surat Fasilitas/Klinik, Logo & Stempel Digital Resmi pada Laporan',
      'Cetak & Ekspor Laporan PDF Interaksi Pasien Lengkap & Arsip Cloud Firebase',
      'Ekspor Rekapitulasi Data Resep & Audit ke Excel/CSV',
      'Modul Standar Operasional Prosedur (SOP) Pelayanan Farmasi Klinis',
      'Dukungan Konsultasi Klinis Prioritas via WhatsApp 24/7'
    ],
    isPopular: true,
...
export const PRICING_FEATURE_COMPARISON: FeatureComparison[] = [
  { featureName: 'Pencarian Monografi Obat & Brand Indonesia (BPOM)', free: 'Akses Seluruhnya (Full)', pro: 'Akses Seluruhnya (Full)' },
  { featureName: 'Kapasitas Cek Interaksi Obat Sekaligus (DDInter)', free: 'Tanpa Batas (>10 Obat)', pro: 'Tanpa Batas (>10 Obat)' },
  { featureName: 'Panduan Cara Pakai Obat & Edukasi Pasien', free: true, pro: true },
  { featureName: 'Kompatibilitas Injeksi IV & ICU (ASHP Trissel’s Y-Site)', free: false, pro: true },
  { featureName: 'Kalkulator Stabilitas & BUD Racikan USP <795>', free: false, pro: true },
  { featureName: 'Kalkulator Dosis Pediatrik & Puyer Anak (BB/BSA)', free: false, pro: true },
  { featureName: 'Skrining Keamanan Ibu Hamil (FDA) & Menyusui (Hale)', free: false, pro: true },
  { featureName: 'Evaluasi Polifarmasi Geriatri (Beers 2023 & STOPP/START)', free: false, pro: true },
  { featureName: 'Generator Kartu PIO WhatsApp Pasien Langsung', free: false, pro: true },
  { featureName: 'Pusat Belajar Farmasi (CBT Vignette & OSCE Station)', free: false, pro: true },
  { featureName: 'Interaksi Obat & Uji Lab Semu (False Result)', free: false, pro: true },
  { featureName: 'Interaksi Herbal/Jamu vs Obat Resep (FOHI)', free: false, pro: true },
  { featureName: 'Pusat Analisis Efek Samping Obat & Skor Naranjo ADR', free: false, pro: true },
  { featureName: 'Suite Kalkulator Medis (14+ Skor & CrCl/eGFR Ginjal)', free: false, pro: true },
  { featureName: 'Cek Interaksi Makanan (DFI) & Duplikasi Terapi', free: false, pro: true },
  { featureName: 'Panduan Praktik Klinis Terstandarisasi (PNPK Kemenkes)', free: false, pro: true },
  { featureName: 'Ekspor & Cetak Laporan PDF Interaksi Pasien', free: false, pro: true },
  { featureName: 'Kop Surat Klinik, Logo & Stempel Digital Resmi', free: false, pro: true },
  ...
  { featureName: 'Modul SOP Pelayanan Farmasi Klinis Resmi', free: false, pro: true },
