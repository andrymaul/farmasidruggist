 ...
 * 
 * Direct mapping from DDInter Database schema:
 * Source: https://ddinter.scbdd.com/ddinter/interaction/
 * Developed by Central South University.
 * 
 * Standards:
 * - Evidence-based PK/PD interaction mechanisms
 * - Categorized by Major, Moderate, Minor severity
 * - Verified 100% duplicate-free against existing databases
 * - Fully synchronized with Indonesian Formularium Nasional (Fornas) & clinical hospital pharmacy practice
 */
