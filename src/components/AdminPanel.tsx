        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-stretch sm:items-end gap-2.5 shrink-0 relative z-10">
            <div className="bg-slate-950/80 px-4 py-2.5 rounded-2xl border border-amber-950/60 text-right shadow-md">
              ...
              <span className="text-lg font-black text-amber-300">{drugs.length} Obat Master</span>
            </div>
            <button
              onClick={onSeedFirebase}
              className="bg-amber-600 hover:bg-amber-500 text-white px-4 py-2.5 rounded-xl flex items-center justify-center gap-2 text-xs font-bold transition-all shadow-md cursor-pointer active:scale-95"
            >
