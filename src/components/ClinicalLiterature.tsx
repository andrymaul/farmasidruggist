      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-teal-950 to-slate-950 text-white p-6 sm:p-10 shadow-2xl border border-teal-500/20">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-6 border-t border-white/10">
            ...
            <div className="bg-white/5 backdrop-blur-xs p-3.5 rounded-2xl border border-white/5">
              <div className="text-xl sm:text-2xl font-black font-outfit text-emerald-400">8+ Sumber Primer</div>
      ...
      <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center justify-between">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Cari literatur, institusi (Kemenkes, PERKI, ASHP), obat, atau topik penyakit..."
